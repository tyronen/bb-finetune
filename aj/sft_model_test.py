...
with torch.no_grad():
    ...
    sft_summary = tokenizer.decode(sft_outputs[0][inputs["input_ids"].shape[1]:], skip_special_tokens=True)
...
with torch.no_grad():
    ...
    base_summary = tokenizer.decode(base_outputs[0][inputs["input_ids"].shape[1]:], skip_special_tokens=True)
